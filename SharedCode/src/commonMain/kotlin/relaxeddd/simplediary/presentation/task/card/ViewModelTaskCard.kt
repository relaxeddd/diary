package relaxeddd.simplediary.presentation.task.card
...
import relaxeddd.simplediary.domain.TIME_15_MINUTE
import relaxeddd.simplediary.domain.TIME_DAY
...
import relaxeddd.simplediary.presentation.task.ViewModelTask

internal class ViewModelTaskCard(private val repositoryTasks: RepositoryTasks) : ViewModelTask(repositoryTasks),
    IViewModelTaskCard {
