...
import relaxeddd.simplediary.domain.TIME_WEEK
...
internal abstract class ViewModelTaskList(private val repositoryTasks: RepositoryTasks) : ViewModelTask(repositoryTasks),
    IViewModelTaskList {
